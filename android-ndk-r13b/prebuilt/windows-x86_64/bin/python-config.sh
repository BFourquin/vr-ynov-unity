...
prefix_build="/usr/local/google/buildbot/src/android/ndk-r13-release/out/build/buildhost/windows-x86_64/install/host-tools"
...
CFLAGS="-O2 -Os -fomit-frame-pointer -s -D__USE_MINGW_ANSI_STDIO=1 -static-libgcc"
VERSION="2.7"
LIBM=""
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBS="-lpython${VERSION}${ABIFLAGS}  $SYSLIBS"
